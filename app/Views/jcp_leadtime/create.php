...
<div class="pd-ltr-20 xs-pd-20-10">
  <div class="min-height-200px">
    ...
    <div class="pd-20 card-box mb-30">
      <form action="<?= site_url('jcp-master-leadtime/store') ?>" method="post">
        <?= csrf_field() ?>
        ...
        <div class="form-group row">
          <div class="col-md-4">
            ...
            <input type="number" name="measuring_hour" class="form-control">
          </div>
          <div class="col-md-4">
            <label>Laser Cutting</label>
            <input type="number" name="hour_machine_laser_cutting" class="form-control">
          </div>
          <div class="col-md-4">
            <label>Big Machine</label>
            <input type="number" name="hour_machine_big" class="form-control">
          </div>
        </div>
        <div class="form-group row">
          <div class="col-md-4">
            <label>Small Machine</label>
            <input type="number" name="hour_machine_small" class="form-control">
          </div>
          <div class="col-md-4">
            <label>Total Day</label>
            <input type="number" name="total_day" class="form-control">
          </div>
          <div class="col-md-4">
            <label>Status</label>
