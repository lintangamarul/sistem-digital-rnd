    ...
    <div class="min-height-200px">
        ...
        <div class="card-box mb-30">
            <div class="pd-20">
                ...
                <form method="get" action="<?= site_url('history-monthly'); ?>" class="d-flex align-items-center">
                    <label for="month" class="mr-2 mb-0">Pilih Bulan:</label>
                    <select name="month" class="custom-select2 form-control" style="width: 100%; height: 38px;" onchange="this.form.submit()">
                ...
                <div class="mt-3 mb-3 ml-3">
                    ...
                    <div class="table-responsive">
                        ...
                        <thead>
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="2"><strong>Persentase Kehadiran per Hari</strong></td>
                                    <?php foreach ($dates as $date): ?>
